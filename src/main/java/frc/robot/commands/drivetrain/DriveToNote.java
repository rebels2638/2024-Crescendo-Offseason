...
public class DriveToNote extends Command {
    ...
    private Rotation2d initialYaw = new Rotation2d(); // Initial yaw of the robot
    private boolean over = false; // Flag to toggle rotation behavior
    ...
    public DriveToNote(SwerveDrive swerveDrive, Intake intakeSubsystem, NoteDetector noteDetector) {
        ...
        switch (Constants.currentMode) {
            ...
            default:
                m_translationalController = new PIDController(1, 0, 0); // Real translational controller gains
                m_rotationalController = new ProfiledPIDController(2, 0, 0,
                 new Constraints(Constants.Auton.MAX_ANGULAR_VELO_RPS * 2 * Math.PI, 
    ...
    public void initialize() {
        initialYaw = swerveDrive.getPose().getRotation(); // Store the initial yaw of the robot
        Logger.recordOutput("IntakeNoteCommand/end", false); // Log initialization status
    }
